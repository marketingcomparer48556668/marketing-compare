      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex items-start justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Customer.io</h1>
              <p className="text-xl text-gray-600">Automated messaging that humans love</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Customer.io is a behavioral messaging platform that helps you send relevant messages based on customer behavior.
              </p>
              <p className="text-gray-700">
                Perfect for product-led growth companies with a developer-friendly API and powerful workflow builder.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Product-led growth</span></div>
                <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>SaaS companies</span></div>
                <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Developer teams</span></div>
                <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Behavior-based messaging</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border-2 border-blue-500">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li>Up to 25,000 profiles</li>
                  <li>Email + push + in-app</li>
                  <li>Advanced features</li>
                </ul>
              </div>
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2">Enterprise</h3>
                <p className="text-3xl font-bold text-blue-600 mb-4">$999<span className="text-lg font-normal text-gray-600">/mo</span></p>
                <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Visual workflow builder</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Behavioral triggers</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Developer-friendly API</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Split testing</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Data pipelines</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Segmentation</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Dynamic content</span></li>
              <li className="flex items-center gap-2"><span className="text-green-500">✓</span><span>Webhooks</span></li>
            </ul>
          </div>
        </div>
      </div>
